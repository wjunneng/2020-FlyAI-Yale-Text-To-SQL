...
import os
import pickle
from src.preprocess.utils import symbol_filter, re_lemma, fully_part_header, group_header, partial_header, num2year, \
    group_symbol, group_values, group_digital
from src.preprocess.utils import AGG, wordnet_lemmatizer
from src.preprocess.utils import load_dataSets
...
#     """
#     # train
#     # args.data_path = '../../data_yan/train.json'
#     # args.table_path = '../../data_yan/tables.json'
#     # args.output = '../../data_yan/train_process.json'
#
#     args.data_path = '../../data_yan/test.json'
#     args.table_path = '../../data_yan/tables.json'
#     args.output = '../../data_yan/test_process.json'
#
